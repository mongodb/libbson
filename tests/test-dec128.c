...
#define DEC128_FROM_ULLS(dec, h, l) do { (dec).high = (h); (dec).low = (l); } \
   while (0);


static void
test_dec128_to_string__infinity (void) {
   bson_dec128_t positive_infinity;
   bson_dec128_t negative_infinity;
   char bid_string[BSON_DEC128_STRING];

   DEC128_FROM_ULLS (positive_infinity, 0x7800000000000000, 0);
   DEC128_FROM_ULLS (negative_infinity, 0xf800000000000000, 0);
...
test_dec128_to_string__nan (void) {
   bson_dec128_t dec_pnan;
   bson_dec128_t dec_nnan;
   bson_dec128_t dec_psnan;
   bson_dec128_t dec_nsnan;
   bson_dec128_t dec_payload_nan;

   /* All the above should just be NaN. */
   char bid_string[BSON_DEC128_STRING];

   DEC128_FROM_ULLS (dec_pnan, 0x7c00000000000000, 0);
   DEC128_FROM_ULLS (dec_nnan, 0xfc00000000000000, 0);
   DEC128_FROM_ULLS (dec_psnan, 0x7e00000000000000, 0);
   DEC128_FROM_ULLS (dec_nsnan, 0xfe00000000000000, 0);
   DEC128_FROM_ULLS (dec_payload_nan, 0x7e00000000000000, 12);
...
test_dec128_to_string__regular (void) {
   ...
   bson_dec128_t tenth;
   bson_dec128_t smallest_regular;
   bson_dec128_t largest_regular;
   bson_dec128_t trailing_zeros;
   bson_dec128_t all_digits;

   DEC128_FROM_ULLS (one, 0x3040000000000000, 0x0000000000000001);
   DEC128_FROM_ULLS (zero, 0x3040000000000000, 0x0000000000000000);
   DEC128_FROM_ULLS (two, 0x3040000000000000, 0x0000000000000002);
   DEC128_FROM_ULLS (negative_one, 0xb040000000000000, 0x0000000000000001);
   DEC128_FROM_ULLS (negative_zero, 0xb040000000000000, 0x0000000000000000);
   DEC128_FROM_ULLS (tenth, 0x303e000000000000, 0x0000000000000001); /* 0.1 */
   /* 0.001234 */
   DEC128_FROM_ULLS (smallest_regular, 0x3034000000000000, 0x00000000000004d2);
   /* 12345789012 */
   DEC128_FROM_ULLS (largest_regular, 0x3040000000000000, 0x0000001cbe991a14);
   /* 0.00123400000 */
   DEC128_FROM_ULLS (trailing_zeros, 0x302a000000000000, 0x00000000075aef40);
   /* 0.1234567890123456789012345678901234 */
   DEC128_FROM_ULLS (all_digits, 0x2ffc3cde6fff9732, 0xde825cd07e96aff2);
...
test_dec128_to_string__scientific (void) {
   ...
   bson_dec128_t tiny;       /* 1E-6176 */
   bson_dec128_t neg_tiny;   /* -1E-6176 */
   bson_dec128_t large;      /* 9.999987654321E+112 */
   ...
   DEC128_FROM_ULLS (neg_tiny, 0x8000000000000000, 0x0000000000000001);
   DEC128_FROM_ULLS (large, 0x3108000000000000, 0x000009184db63eb1);
...
test_dec128_to_string__zeros (void) {
   ...
   DEC128_FROM_ULLS (zero, 0x3040000000000000, 0x0000000000000000);
   DEC128_FROM_ULLS (pos_exp_zero, 0x3298000000000000, 0x0000000000000000);
   DEC128_FROM_ULLS (neg_exp_zero, 0x2b90000000000000, 0x0000000000000000);
...
static bool dec128_equal(bson_dec128_t *dec, uint64_t high, uint64_t low) {
   bson_dec128_t test;
   DEC128_FROM_ULLS(test, high, low);
