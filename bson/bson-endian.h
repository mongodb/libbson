...
__bson_uint16_swap_slow (bson_uint16_t v)
{
...
#    define BSON_UINT32_SWAP_LE_BE(v) __builtin_bswap32 ((bson_uint32_t)v)
#    define BSON_UINT64_SWAP_LE_BE(v) __builtin_bswap64 ((bson_uint64_t)v)
#  endif
#  if __GNUC__ >= 4 && defined (__GNUC_MINOR__) && __GNUC_MINOR__ >= 8
#    define BSON_UINT16_SWAP_LE_BE(v) __builtin_bswap16 ((bson_uint32_t)v)
#  endif
#endif
...
#  define BSON_UINT16_FROM_BE(v)  ((bson_uint16_t)v)
#  define BSON_UINT16_TO_BE(v)    ((bson_uint16_t)v)
#  define BSON_UINT32_FROM_LE(v)  BSON_UINT32_SWAP_LE_BE (v)
#  define BSON_UINT32_TO_LE(v)    BSON_UINT32_SWAP_LE_BE (v)
#  define BSON_UINT32_FROM_BE(v)  ((bson_uint32_t)v)
#  define BSON_UINT32_TO_BE(v)    ((bson_uint32_t)v)
#  define BSON_UINT64_FROM_LE(v)  BSON_UINT64_SWAP_LE_BE (v)
#  define BSON_UINT64_TO_LE(v)    BSON_UINT64_SWAP_LE_BE (v)
#  define BSON_UINT64_FROM_BE(v)  ((bson_uint64_t)v)
#  define BSON_UINT64_TO_BE(v)    ((bson_uint64_t)v)
